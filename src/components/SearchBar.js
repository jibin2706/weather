...
function SearchBar({ locationName, setLocation }) {
  // TODO: need to use geocoding api to get address from coordinates
  const [searchText, setSearchText] = useState(locationName || 'Mumbai, Maharashtra')
